  ...
  return (
    <div className="flex min-h-screen w-full bg-white">
      ...
      <div className="hidden w-1/2 bg-slate-50 lg:flex items-center justify-center relative overflow-hidden">
        <div className="absolute top-[-10%] left-[-10%] w-96 h-96 bg-[#2E9FFB]/20 rounded-full blur-3xl animate-float opacity-70"></div>
        ...
        <div className="relative z-10 p-12 text-center max-w-lg">
            <div className="inline-flex items-center justify-center p-3 mb-6 rounded-2xl bg-white shadow-xl shadow-slate-200/50">
                <Zap className="w-8 h-8 text-[#2E9FFB]" />
            </div>
            <h2 className="text-4xl font-extrabold text-slate-900 mb-4 leading-tight">
                Únete a <span className="text-[#2E9FFB]">PEAI</span>
            </h2>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form action={dispatch} className="mt-8 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="relative">
                    ...
                    <label 
                        ...
                        className="flex flex-col items-center justify-center rounded-xl border-2 border-slate-200 p-4 cursor-pointer transition-all hover:bg-slate-50 peer-checked:border-[#FBE02E] peer-checked:bg-[#FBE02E]/5 peer-checked:text-[#FBE02E]"
                    >
            ...
            <div className="text-center text-sm">
              ...
              <Link href="/login" className="font-bold text-[#2E9FFB] hover:text-[#2E9FFB]/80 transition-colors">
                Inicia sesión aquí
              </Link>
            </div>
          </form>
